...
import { signup } from "./dist/signup"
...
let signInProcess = () => {
    ...
    signInButton.onclick = () => {
        ...
        let passInput = signUp.passInputArea
        ...
        firebase.auth().signInWithEmailAndPassword(email, password)
            .catch(function (error) {
                ...
                if (errorCode == 'auth/user-not-found') {
                    emailInput.setAttribute('placeholer', "email not registered")
                }
                else if (errorCode == 'auth/invalid-email') {
                    emailInput.setAttribute('placeholer', "invalid email/password")
                }
                else if (errorCode == 'auth/wrong-password') {
                    passInput.setAttribute('placeholer', "Invalid email/password")
                }
        })
    }
